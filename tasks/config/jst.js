...
module.exports = function(grunt) {
	...
	grunt.config.set('jst', {
		dev: {
			...
			// To use other sorts of views, specify a regexp like the example below:
			// options: {
			//   templateSettings: {
			//     interpolate: /\{\{(.+?)\}\}/g
			//   }
			...
			// default interpolation. If you want to parse views with the default _.template behavior
